...
if not os.path.isdir(f'/home/{method}/save_tsne'):
    os.makedirs(f'/home/{method}/save_tsne')

result = scipy.io.loadmat(f'/home/{method}/tsne.mat')
...
def train(epoch):
    ...
    with torch.no_grad():
      for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
          ...
          plt.savefig(osp.join(f'/home/{method}/save_tsne', 'tsne_{}.jpg'.format(batch_idx)))
