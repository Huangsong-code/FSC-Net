...
parser.add_argument('--data_path',default='/root/autodl-tmp/LLCM/',type=str, help='./test_data')
parser.add_argument('--img_w', default=144, type=int, metavar='imgw', help='img width')
parser.add_argument('--img_h', default=288, type=int, metavar='imgh', help='img height')
args = parser.parse_args()

method = 'FSC-Net'   # 实际使用中需要修改不同的模型名称
...
if not os.path.isdir(f'/home/{method}/save_ranking'):
    os.makedirs(f'/home/{method}/save_ranking')
...
for j in range(30000):
    if j % 10 == 0:
        ...
        fig.savefig(f"/home/{method}/save_ranking/" + str(j) + ".jpg")
