...
from model_FSC import embed_net
from utils import *
from loss import OriTripletLoss, CPMLoss
from tensorboardX import SummaryWriter
from random_erasing import RandomErasing
from RCA import RandomChannelExchangeable
...
parser.add_argument('--model_path', default='/root/autodl-fs/FSC/save_model/', type=str, help='model save path')
parser.add_argument('--save_epoch', default=20, type=int, metavar='s', help='save model every 10 epochs')
parser.add_argument('--log_path', default='/root/autodl-fs/FSC/log/', type=str, help='log save path')
parser.add_argument('--vis_log_path', default='/root/autodl-fs/FSC/log/vis_log/', type=str, help='log save path')
...
suffix = dataset
suffix = suffix + '_model_p{}_n{}_lr_{}_lambda2_{}_seed_{}'.format(args.num_pos, args.batch_size, args.lr, args.lambda_2, args.seed)
